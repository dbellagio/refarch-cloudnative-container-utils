...
echo "appetizer"
cf ic group create --name appetizer -p 8082 -m 512 --min 1 --max 2 --desired 1 --env-file ~/env-only-spring-config-bx registry.ng.bluemix.net/supercontainers/wfd-appetizer:dev

echo "sleeping 10"
sleep 10

echo "dessert"
cf ic group create --name dessert -p 8083 -m 512 --min 1 --max 2 --desired 1 --env-file env-only-spring-config-bx registry.ng.bluemix.net/supercontainers/wfd-dessert:dev

echo "sleeping 10"
sleep 10

echo "entree"
cf ic group create --name entree -p 8081 -m 512 --min 1 --max 2 --desired 1 --env-file env-only-spring-config-bx registry.ng.bluemix.net/supercontainers/wfd-entree:dev

echo "sleeping 120"
sleep 120

echo "create group for menu, pass in Eureka"
cf ic group create --name menu -p 8180 -m 512 --min 1 --max 2 --desired 1 --env-file env-eureka-only-bx registry.ng.bluemix.net/supercontainers/wfd-menu:dev

echo "sleeping 60"
sleep 60

echo "create group for wfd-ui, pass in Eureka"
cf ic group create --name wfd-ui -p 8181 -m 512 --min 1 --max 2 --desired 1 --env-file env-eureka-only-bx registry.ng.bluemix.net/supercontainers/wfd-ui:dev

echo "sleeping 60"
sleep 60

echo "create group for turbine, pass in Eureka"
cf ic group create --name netflix-turbine -p 8989 -m 512 --min 1 --max 2 --desired 1 --env-file env-eureka-only-bx registry.ng.bluemix.net/supercontainers/netflix-turbine:dev
